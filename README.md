...
RadarHub a hub for radars and users. One of the main usage is for users to visualize real-time and archived datasets.

RadarHub a [Django]-[Channels] web interface for ARRC radar operations.
