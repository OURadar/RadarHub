...
healths = [
    {
        "Python": {"Value": True, "Enum": 4},
        "Transceiver": {"Value": True, "Enum": 0},
        "Pedestal": {"Value": True, "Enum": 0},
        "Health Relay": {"Value": False, "Enum": 2},
        "Internet": {"Value": True, "Enum": 0},
        "Recorder": {"Value": False, "Enum": 1},
        "Ring Filter": {"Value": False, "Enum": 1},
        "Processors": {"Value": True, "Enum": 0},
        "Measured PRF": {"Value": "1,475 Hz", "Enum": 0},
        "Noise": [50.274, 33.654],
        "Position Rate": {"Value": "249 Hz", "Enum": 0},
        "rayRate": 6.010,
        "10-MHz Clock": {"Value": True, "Enum": 0},
        "DAC PLL": {"Value": True, "Enum": 0},
        "FPGA Temp": {"Value": "61.5degC", "Enum": 0},
        "Core Volt": {"Value": "1.00 V", "Enum": 0},
        "Aux. Volt": {"Value": "2.466 V", "Enum": 0},
        "XMC Volt": {"Value": "12.223 V", "Enum": 0},
        "XMC 3p3": {"Value": "3.222 V", "Enum": 0},
        "Transmit H": {"Value": "57.625 dBm", "Enum": 0, "MaxIndex": 0, "Max": "4.282 dBm", "Min": "3.827 dBm"},
        "Transmit V": {"Value": "53.309 dBm", "Enum": 0, "MaxIndex": 1, "Max": "-0.042 dBm", "Min": "-0.485 dBm"},
        "DAC QI": {"Value": "0.237", "Enum": 1},
        "Waveform": {"Value": "x706", "Enum": 0},
        "UnderOver": [0, 233116],
        "Lags": [-1167035501, -1167035501, -1185559874],
        "NULL": [1602822],
        "Pedestal AZ Interlock": {"Value": True, "Enum": 0},
        "Pedestal EL Interlock": {"Value": True, "Enum": 0},
        "VCP Active": {"Value": True, "Enum": 0},
        "Pedestal AZ": {"Value": "337.89 deg", "Enum": 0},
        "Pedestal EL": {"Value": "3.18 deg", "Enum": 0},
        "Pedestal Update": "251.021 Hz",
        "PedestalHealthEnd": 0,
        "GPS Valid": {"Value": True, "Enum": 3},
        "GPS Latitude": {"Value": "35.2369167", "Enum": 3},
        "GPS Longitude": {"Value": "-97.4638233", "Enum": 3},
        "T-Box Bearing": {"Value": "-448.9 deg", "Enum": 0},
        "T-Box Temp": {"Value": "19.6 degC", "Enum": 0},
        "T-Box Pressure": {"Value": "985.7 hPa", "Enum": 0},
        "RF TRX Health": {"Value": "0x70", "Enum": 2},
        "RF Over Temp H": {"Value": True, "Enum": 0},
        "RF Over Temp V": {"Value": False, "Enum": 2},
        "RF VSWR H": {"Value": True, "Enum": 1},
        "RF VSWR V": {"Value": True, "Enum": 0},
        "STALO": {"Value": True, "Enum": 0},
        "tic": "31008358",
        "Heading Override": {"Value": True, "Enum": 0},
        "Sys Heading": {"Value": "181.00 deg", "Enum": 0},
        "GPS Override": {"Value": True, "Enum": 0},
        "Sys Latitude": {"Value": "35.2369467", "Enum": 0},
        "Sys Longitude": {"Value": "-97.4638167", "Enum": 0},
        "Log Time": 1570804516,
    },
    {
        "Python": {"Value": True, "Enum": 4},
        ...
        "Pedestal": {"Value": True, "Enum": 0},
        "Health Relay": {"Value": False, "Enum": 2},
        "Internet": {"Value": True, "Enum": 1},
        "Recorder": {"Value": False, "Enum": 2},
        "Ring Filter": {"Value": False, "Enum": 1},
        "Processors": {"Value": True, "Enum": 0},
        "Measured PRF": {"Value": "1,476 Hz", "Enum": 0},
        "Noise": [50.274, 33.654],
        "Position Rate": {"Value": "251 Hz", "Enum": 0},
        "rayRate": 6.001,
        "10-MHz Clock": {"Value": True, "Enum": 0},
        "DAC PLL": {"Value": True, "Enum": 0},
        "FPGA Temp": {"Value": "61.4degC", "Enum": 0},
        "Core Volt": {"Value": "1.01 V", "Enum": 0},
        "Aux. Volt": {"Value": "2.464 V", "Enum": 0},
        "XMC Volt": {"Value": "12.225 V", "Enum": 0},
        "XMC 3p3": {"Value": "3.220 V", "Enum": 0},
        "Transmit H": {"Value": "57.511 dBm", "Enum": 0, "MaxIndex": 0, "Max": "4.282 dBm", "Min": "3.827 dBm"},
        "Transmit V": {"Value": "53.309 dBm", "Enum": 0, "MaxIndex": 1, "Max": "-0.042 dBm", "Min": "-0.485 dBm"},
        "DAC QI": {"Value": "0.881", "Enum": 0},
        "Waveform": {"Value": "x706", "Enum": 0},
        "UnderOver": [0, 233116],
        "Lags": [-1167035501, -1167035501, -1185559874],
        "NULL": [1602822],
        ...
        "PedestalHealthEnd": 0,
        "GPS Valid": {"Value": True, "Enum": 3},
        "GPS Latitude": {"Value": "35.2369165", "Enum": 3},
        "GPS Longitude": {"Value": "-97.4638230", "Enum": 3},
        "T-Box Bearing": {"Value": "-448.9 deg", "Enum": 0},
        "T-Box Temp": {"Value": "19.6 degC", "Enum": 0},
        "T-Box Pressure": {"Value": "984.3 hPa", "Enum": 0},
        "RF TRX Health": {"Value": "0x71", "Enum": 0},
        "RF Over Temp H": {"Value": True, "Enum": 0},
        "RF Over Temp V": {"Value": False, "Enum": 2},
        "RF VSWR H": {"Value": True, "Enum": 0},
        "RF VSWR V": {"Value": True, "Enum": 0},
        "STALO": {"Value": True, "Enum": 0},
        "tic": "31008358",
        "Heading Override": {"Value": True, "Enum": 1},
        "Sys Heading": {"Value": "180.00 deg", "Enum": 0},
        "GPS Override": {"Value": True, "Enum": 0},
        "Sys Latitude": {"Value": "35.2369467", "Enum": 0},
        "Sys Longitude": {"Value": "-97.4638167", "Enum": 0},
        "Log Time": 1570804517,
    },
    {
        ...
        "Pedestal": {"Value": True, "Enum": 0},
        "Health Relay": {"Value": False, "Enum": 2},
        "Internet": {"Value": True, "Enum": 2},
        "Recorder": {"Value": False, "Enum": 0},
        "Ring Filter": {"Value": False, "Enum": 1},
        "Processors": {"Value": True, "Enum": 0},
        "Measured PRF": {"Value": "1,475 Hz", "Enum": 0},
        "Noise": [50.274, 33.654],
        "Position Rate": {"Value": "250 Hz", "Enum": 0},
        "rayRate": 6.005,
        "10-MHz Clock": {"Value": True, "Enum": 0},
        "DAC PLL": {"Value": True, "Enum": 1},
        "FPGA Temp": {"Value": "61.4degC", "Enum": 0},
        "Core Volt": {"Value": "1.02 V", "Enum": 0},
        "Aux. Volt": {"Value": "2.468 V", "Enum": 0},
        "XMC Volt": {"Value": "12.224 V", "Enum": 0},
        "XMC 3p3": {"Value": "3.181 V", "Enum": 0},
        "Transmit H": {"Value": "57.326 dBm", "Enum": 0, "MaxIndex": 0, "Max": "4.282 dBm", "Min": "3.827 dBm"},
        "Transmit V": {"Value": "53.309 dBm", "Enum": 0, "MaxIndex": 1, "Max": "-0.042 dBm", "Min": "-0.485 dBm"},
        "DAC QI": {"Value": "0.881", "Enum": 0},
        "Waveform": {"Value": "x706", "Enum": 0},
        "UnderOver": [0, 233116],
        ...
        "T-Box Bearing": {"Value": "-448.9 deg", "Enum": 0},
        "T-Box Temp": {"Value": "19.6 degC", "Enum": 0},
        "T-Box Pressure": {"Value": "985.0 hPa", "Enum": 0},
        "RF TRX Health": {"Value": "0x71", "Enum": 0},
        "RF Over Temp H": {"Value": True, "Enum": 0},
        "RF Over Temp V": {"Value": False, "Enum": 2},
        "RF VSWR H": {"Value": True, "Enum": 0},
        "RF VSWR V": {"Value": True, "Enum": 0},
        "STALO": {"Value": True, "Enum": 1},
        "tic": "31008358",
        "Heading Override": {"Value": True, "Enum": 0},
        "Sys Heading": {"Value": "180.50 deg", "Enum": 0},
        "GPS Override": {"Value": True, "Enum": 0},
        "Sys Latitude": {"Value": "35.2369467", "Enum": 0},
        "Sys Longitude": {"Value": "-97.4638167", "Enum": 0},
        "Log Time": 1570804518,
    },
    {
        ...
        "FPGA Temp": {"Value": "61.4degC", "Enum": 0},
        "Core Volt": {"Value": "1.01 V", "Enum": 0},
        "Aux. Volt": {"Value": "2.463 V", "Enum": 0},
        "XMC Volt": {"Value": "12.222 V", "Enum": 0},
        "XMC 3p3": {"Value": "3.196 V", "Enum": 0},
        "Transmit H": {"Value": "57.326 dBm", "Enum": 0, "MaxIndex": 0, "Max": "4.282 dBm", "Min": "3.827 dBm"},
        "Transmit V": {"Value": "53.309 dBm", "Enum": 0, "MaxIndex": 1, "Max": "-0.042 dBm", "Min": "-0.485 dBm"},
        "DAC QI": {"Value": "0.881", "Enum": 0},
        "Waveform": {"Value": "x706", "Enum": 0},
        ...
        "RF Over Temp V": {"Value": False, "Enum": 2},
        "RF VSWR H": {"Value": True, "Enum": 0},
        "RF VSWR V": {"Value": True, "Enum": 1},
        "STALO": {"Value": True, "Enum": 0},
        "tic": "31008358",
        "Heading Override": {"Value": True, "Enum": 0},
        "Sys Heading": {"Value": "180.75 deg", "Enum": 0},
        "GPS Override": {"Value": True, "Enum": 0},
        "Sys Latitude": {"Value": "35.2369467", "Enum": 0},
        "Sys Longitude": {"Value": "-97.4638167", "Enum": 0},
        "Log Time": 1570804519,
...
def handleOpen(ws):
    ...
    message = json.dumps({"pathway": R.name, "command": "radarGreet", "radar": "Demo"})
    ...
    controls = {
        ...
        "Controls": [
            ...
            {
                "Label": "5-tilt VCP @ 45 deg/s",
                "Command": "p vol p 2 300 45/p 4 300 45/p 6 300 45/p 8 300 45/p 10 300 45",
            },
            {
                "Label": "5-tilt VCP @ 25 deg/s",
                "Command": "p vol p 2 300 25/p 4 300 25/p 6 300 25/p 8 300 25/p 10 300 25",
            },
            {
                "Label": "5-tilt VCP @ 18 deg/s",
                "Command": "p vol p 2 300 18/p 4 300 18/p 6 300 18/p 8 300 18/p 10 300 18",
            },
            {
                "Label": "5-tilt VCP @ 12 deg/s",
                "Command": "p vol p 2 300 12/p 4 300 12/p 6 300 12/p 8 300 12/p 10 300 12",
            },
            {
                "Label": "6-tilt VCP @ 18 deg/s",
                "Command": "p vol p 2 300 18/p 4 300 18/p 6 300 18/p 8 300 18/p 10 300 18/p 12 300 18",
            },
        ],
    }
...
def main():
    ...
    parser.add_argument("host", nargs="?", default="localhost:8000", help="host with or without port number")
