...
def vlabel(values, va=11.57875, t=128):
    ...
    if model is None:
        ...
        if t == 128:
            ...
            model = keras.models.load_model("cnn-models/i5w4.h5", custom_objects=custom_objects())
        elif t == 256:
            # U-Net for input size 256 x 256
            model = keras.models.load_model("cnn-models/i7.h5", custom_objects=custom_objects())
